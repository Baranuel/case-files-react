          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-4 md:grid-cols-1 lg:grid-cols-2 gap-2">
              <Button
                ...
                className="h-full min-h-40 bg-[#FDFBF7] text-[#8B4513] border-dashed border-2 border-[#8B4513] flex items-center gap-2 hover:bg-[#B4540A] hover:text-[#FDFBF7] text-base font-semibold"
                >
