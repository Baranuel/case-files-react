...
export function SharedBoardCard({
  ...
  return (
    ...
    >
      <motion.div
        className=" bg-[#FDFBF7] h-full min-h-36 items-center rounded-lg hover:shadow-lg hover:-translate-y-0.5 transition-all border border-[#8B4513]/20 p-6 flex  gap-3"
      >
